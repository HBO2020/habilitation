...
@RestController
@RequestMapping("/api/habilitation-kafka")
public class HabilitationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HabilitationKafkaResource.class);
    ...
    public HabilitationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
